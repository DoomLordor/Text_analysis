 ...
 namespace Solarix
 {
  ...
  class TreeScorerPoint : lem::NonCopyable
  {
   ...
   public:
    ...
    bool IsWord(void) const { return !word.empty(); }
    bool IsWordentrySet(void) const { return !wordentryset_name.empty(); }
    bool IsWordSet(void) const { return !wordset_name.empty(); }
    bool IsWordformSet(void) const { return !wordformset_name.empty(); }
    bool IsEntry(void) const { return id_entry!=UNKNOWN; }
    bool IsMetaEntry(void) const { return id_metaentry!=UNKNOWN; }
    bool IsClass(void) const { return id_class!=UNKNOWN; }
    bool IsAny(void) const { return id_entry==ANY_STATE; }
