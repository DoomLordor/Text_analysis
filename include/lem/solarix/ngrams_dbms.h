...
#pragma once
 ...
 namespace Solarix
 {
  ...
  class NGramsDBMS : lem::NonCopyable
  {
   ...
   public:
    virtual ~NGramsDBMS(void);

    virtual bool IsRemote(void) const=0;
    virtual NGramsDBMS* CreateDisconnectedClone() const=0;

    virtual int MaxBulkInsert(void) const=0;
    ...
    virtual void CommitReadTx(void)=0;
    virtual void CommitRetaining(void)=0;
    ...
    virtual void CommitCreatedIndeces(void)=0;
    ...
    virtual void CreateTable_Segments(void)=0;
